...
// Define route for updating user password
router.put(
  "/update-password",
...
// Define route for getting user information
router.get("/info", tokenMiddleware.auth, userController.getInfo);

// Define route for getting user's favorite media
router.get(
  "/favorites",
  tokenMiddleware.auth,
...
// Define route for adding a media to user's favorites
router.post(
  "/favorites",
  tokenMiddleware.auth,
  // Validation checks for adding a favorite
  body("mediaType")
    .exists()
...
// Define route for removing a media from user's favorites
router.delete(
